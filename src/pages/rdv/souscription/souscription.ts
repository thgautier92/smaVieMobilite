...
export class SouscriptionPage {
  ...
  refClauses: any = [];
  constructor(public nav: NavController, params: NavParams, public viewCtrl: ViewController, public modal: ModalController, public events: Events, public CalcTools: CalcTools, public paramsApi: Paramsdata, public display: DisplayTools) {
    this.params = params;
...
@Component({
  templateUrl: 'clause_detail.html',
