...
export class ProfilRisquePage {
  ...
  params: NavParams;
  pageStatus: any;
  constructor(public nav: NavController, params: NavParams, public viewCtrl: ViewController, public events: Events, public CalcTools: CalcTools, public loadingCtrl: LoadingController) {
    this.params = params;
