...
import {NavController, NavParams, Events, ModalController, AlertController, ViewController } from 'ionic-angular';
...
export class OptionPiecesPage {
  ...
  constructor(public nav: NavController, params: NavParams, public viewCtrl: ViewController,public modalCtrl: ModalController, public alertCtrl: AlertController, public events: Events, public menu: Paramsdata) {
...
function setOptions(srcType) {
  var options = {
    // Some comon settings are 20, 50, and 100
    quality: 50,
