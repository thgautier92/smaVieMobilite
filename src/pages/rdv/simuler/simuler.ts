...
import {maxByKeyPipe} from '../../../pipes/comon';
...
export class SimulerPage {
  ...
  constructor(public nav: NavController, params: NavParams, public viewCtrl: ViewController, public modalCtrl: ModalController, public events: Events, public display: DisplayTools, public CalcTools: CalcTools, public simu: Simu) {
    this.params = params;
...
// ===== Detail modal =====
@Component({
  templateUrl: 'simuler-detail.html',
})
